"""Run council debate round 24 (multimodal: PDF screenshots + broken answer text)."""
...
PROMPT_FILE = "debate_output/round24_prompt.json"
OUT_FILE = "debate_output/round24.json"
IMAGES = [
    r"C:\Users\LAPTOP~1\AppData\Local\Temp\opencode\error2\page1.png",
    r"C:\Users\LAPTOP~1\AppData\Local\Temp\opencode\error2\page2.png",
    r"C:\Users\LAPTOP~1\AppData\Local\Temp\opencode\error2\page3.png",
]
...
def build_user_content(user_text: str, with_images: bool):
    if not with_images:
        return user_text
...
def call_model(member: dict, user_text: str) -> str:
    ...
    vision = bool(member.get("vision", False))
    body = {
        "model": member["model"],
        "messages": [
            {"role": "system", "content": SYSTEM},
            {"role": "user", "content": build_user_content(user_text, vision)},
        ],
        "temperature": 0.7,
